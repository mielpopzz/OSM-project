...
unvisited = {node: [0, '2000431034'] for node in node1}  # using None as +inf
visited = {}
current = '2000431034'
currentSave = '2000431034'
currentDistance = [0, '2000431034']
...
ax.plot(way_x, way_y, color='yellow', linewidth=3)
plt.show()
